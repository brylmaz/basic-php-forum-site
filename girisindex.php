    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">içerik 1</a>
          <a class="dropdown-item" href="#">içerik 2</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">içerik 3</a>
        </div>
      </li>
      <li class="nav-item">
		...
		<div class="row">
			<!-- Button trigger modal -->
                    <div class="">
                      ...
                      <button type="button" class="btn btn-warning" data-toggle="modal"  >
                       <b><a href="cikis.php" style="color:red; text-decoration:none; ">ÇIKIŞ</a></b> 
                      </button>
                    </div>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
         ...
         <form action="veriler.php" method="GET">
          ...
          <form action="paylas.php" method="GET">
          
         
          <div class="form-group">
            <label for="exampleInputPassword1">Gönderi Paylaş</label>
            <input type="text" class="form-control" id="exampleInputPassword1" name="gonderi">
          </div>
...
$sql = "SELECT * FROM paylas ORDER BY id DESC LIMIT 0,5";
