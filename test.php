...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand" href="#">
     <img src="http://localhost:82/Sitem/image/1200px-Bootstrap_logo.svg.png" width="30" height="30" class="d-inline-block align-top" alt=""> 
    Bootstrap
  </a>
</nav>
			...
			<!-- Modal -->
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="http://localhost:82/Sitem/image/1200px-Bootstrap_logo.svg.png" class="d-block img-fluid" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="http://localhost:82/Sitem/image/image_750x_5dff7aa2e7046.jpg" class="d-block img-fluid" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="http://localhost:82/Sitem/image/1200px-Bootstrap_logo.svg.png" class="d-block img-fluid" alt="...">
                </div>
                ...
                <div class="alert alert-success">
                 ...
                 <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <button class="btn btn-outline-secondary" type="submit" name="gonder">Button</button>
            
                      </div>
          
                    <input type="text" class="form-control" placeholder="" aria-label="" name="sezarname" aria-describedby="basic-addon1">
